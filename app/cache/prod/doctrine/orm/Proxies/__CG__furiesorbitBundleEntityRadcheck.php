 ...
 */
class Radcheck extends \furies\orbitBundle\Entity\Radcheck implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'furies\\orbitBundle\\Entity\\Radcheck' . "\0" . 'username', '' . "\0" . 'furies\\orbitBundle\\Entity\\Radcheck' . "\0" . 'attribute', '' . "\0" . 'furies\\orbitBundle\\Entity\\Radcheck' . "\0" . 'op', '' . "\0" . 'furies\\orbitBundle\\Entity\\Radcheck' . "\0" . 'value', '' . "\0" . 'furies\\orbitBundle\\Entity\\Radcheck' . "\0" . 'companyid', '' . "\0" . 'furies\\orbitBundle\\Entity\\Radcheck' . "\0" . 'id', '' . "\0" . 'furies\\orbitBundle\\Entity\\Radcheck' . "\0" . 'circuitid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Radcheck $proxy) {
