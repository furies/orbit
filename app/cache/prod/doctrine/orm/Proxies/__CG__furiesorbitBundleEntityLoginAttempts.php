 ...
 */
class LoginAttempts extends \furies\orbitBundle\Entity\LoginAttempts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'furies\\orbitBundle\\Entity\\LoginAttempts' . "\0" . 'userId', '' . "\0" . 'furies\\orbitBundle\\Entity\\LoginAttempts' . "\0" . 'time', '' . "\0" . 'furies\\orbitBundle\\Entity\\LoginAttempts' . "\0" . 'companyid', '' . "\0" . 'furies\\orbitBundle\\Entity\\LoginAttempts' . "\0" . 'loginAttemptsid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LoginAttempts $proxy) {
    ...
    public function getLoginAttemptsid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getLoginAttemptsid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLoginAttemptsid', array());

        return parent::getLoginAttemptsid();
    }
